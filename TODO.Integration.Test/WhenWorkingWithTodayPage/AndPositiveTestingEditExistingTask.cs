...
namespace TODO.Integration.Test.WhenWorkingWithTodayPage
{
    ...
    class AndPositiveTestingEditExistingTask
    {
        ...
        public void TestingEditTask()
        {
            ...
            _wait.Until(ExpectedConditions.ElementExists(By.XPath("//*[@id='main-content']/section/div/div[1]/div/section/div/div[1]/ul/li/div[2]/div/a/i")));
            _wait.Until(ExpectedConditions.ElementIsVisible(By.XPath("//*[@id='main-content']/section/div/div[1]/div/section/div/div[1]/ul/li/div[2]/div/a/i")));
            var editbutton =_driver.FindElement(By.XPath("//*[@id='main-content']/section/div/div[1]/div/section/div/div[1]/ul/li/div[2]/div/a/i"));
            editbutton.Click();
